...
-- NOTE: project_assignments has no surrogate id column (only project_id +
-- manager_id as its natural key, per js/api/projects.js) — verified live
-- 2026-07-15 after the original query (with pa.id) threw 42703.
